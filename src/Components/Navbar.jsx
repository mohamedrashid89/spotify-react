    ...
    <>
        <div className="w-full flex justify-between items-center font-semibold">
            ...
            <div className="flex items-center gap-4">
                <p className="bg-white text-black text-[15px] px-2 py-1 rounded-2xl hidden md:block cursor-pointer">Explore Premium</p>
                <p className="bg-black px-4 py-1 rounded-2xl text-[15px] cursor-pointer">Install App</p>
